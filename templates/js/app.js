    ...
    load_app: function () {
        window.app_ovh_ip_manager = new Vue({
            ...
            data: {
                ...
                tcp_fragments: false,
                tcp_flag: 'none',
                changing_mitigation_alert: false,
                discord_webhook_url: '',
                saving_discord_webhook_url: false
            },
            watch: {
            ...
            methods: {
                ...
                change_mitigation_alert: function (item, notif_type) {
                    var context = this;
                    this.changing_mitigation_alert = true;
                    var enable = item['notif_' + notif_type] ? 'yes' : 'no';
                    console.log( 'notif_' + notif_type + ' = ' + item['notif_' + notif_type] );
                    ...
                    $.ajax({
                        ...
                        complete: function () {
                            context.changing_mitigation_alert = false;
                        }
                    });
                },

                saveDiscordWebhookURL: function ( ) {
                    var context = this;
                    if ( this.saving_discord_webhook_url ) {
                        return;
                    }
                    this.saving_discord_webhook_url = true;
                    $.ajax({
                        url: ajaxurl + '/modules/addons/ovh_ip_manager/ajax.php',
                        type: 'POST',
                        data: {
                            action: 'save_discord_webhook_url',
                        ...
                        complete: function () {
                            context.saving_discord_webhook_url = false;
                        }
                    });
                },

                loadDiscordWebhookURL: function ( ) {
                    var context = this;
                    $.ajax({
                        url: ajaxurl + '/modules/addons/ovh_ip_manager/ajax.php',
                        type: 'POST',
                        data: {
                            action: 'get_discord_webhook_url',
                        },
                        success: function (resp) {
                            console.log(resp);
                            if ( typeof resp.url !== "undefined" ) {
                                context.discord_webhook_url = resp.url;
                            }
                        },
                        complete: function () {
                        }
